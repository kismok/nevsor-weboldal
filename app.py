...
# Adatbázis helye
DB_PATH = os.environ.get("DATABASE_PATH", "/app/data/nevsor.db")

# Ha az adatbázis mappája nem létezik, hozza létre
...
def init_db():
    # Biztosítjuk, hogy az adatbázis könyvtára létezzen
    db_dir = os.path.dirname(DB_PATH)
    if db_dir:
        os.makedirs(db_dir, exist_ok=True)
